...
const advantages = [
  ...
  { 
    ...
    desc: 'Используем только лиственницу класса А (без сучков) и пищевую нержавеющую сталь AISI 304/316.', 
    icon: <Gem size={32} /> 
  },
  { 
    id: 3, 
  ...
  { 
    ...
    desc: 'Официальная гарантия до 12 лет. Постгарантийное обслуживание и выезд мастера.', 
